...
$tempColumns = [
    ...
    'tx_typo3forum_post_count_session' => [
        'exclude' => 1,
        'label' => 'LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xlf:fe_users.tx_typo3forum_post_count_session',
        'config' => ['type' => 'none'],
    ],
    ...
    'tx_typo3forum_helpful_count_session' => [
        'exclude' => 1,
        'label' => 'LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xlf:fe_users.tx_typo3forum_helpful_count_session',
        'config' => ['type' => 'none'],
    ],
    ...
    'tx_typo3forum_topic_favsubscriptions' => [
        'exclude' => 1,
        'label' => 'LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xlf:fe_users.tx_typo3forum_topic_favsubscriptions',
        'config' => [
            'type' => 'select',
    ...
    'tx_typo3forum_private_messages' => [
        'exclude' => 1,
        'label' => 'LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xlf:fe_users.tx_typo3forum_domain_model_user_pm',
        'config' => [
            'type' => 'inline',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem('fe_users', 'tx_extbase_type', [
    'LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xlf:fe_users.tx_extbase_type.typo3_forum',
