...
$tempColumns = [
	...
	'tx_typo3forum_post_count_season' => [
		'exclude' => 1,
		'label' => $lllPath . 'tx_typo3forum_post_count_season',
		'config' => ['type' => 'none'],
	],
	...
	'tx_typo3forum_helpful_count_season' => [
		'exclude' => 1,
		'label' => $lllPath . 'tx_typo3forum_helpful_count_season',
		'config' => ['type' => 'none'],
	],
