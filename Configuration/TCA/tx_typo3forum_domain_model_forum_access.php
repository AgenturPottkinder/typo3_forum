	...
	'columns' => [
		...
		'operation' => [
			...
			'config' => [
				...
				'maxitems' => 1,
				'items' => [
					[$lllPath . 'operation.read', 'read'],
					[$lllPath . 'operation.newTopic', 'newTopic'],
					[$lllPath . 'operation.newPost', 'newPost'],
					[$lllPath . 'operation.newAttachment', 'newAttachment'],
					[$lllPath . 'operation.editPost', 'editPost'],
					[$lllPath . 'operation.deletePost', 'deletePost'],
					[$lllPath . 'operation.moderation', 'moderate'],
				],
			],
		],
		'negate' => [
