        ...
        'operation' => [
            ...
            'config' => [
                ...
                'items' => [
                    ...
                    ['LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xml:tx_typo3forum_domain_model_forum_access.operation.deleteTopic', \Mittwald\Typo3Forum\Domain\Model\Forum\Access::TYPE_DELETE_TOPIC],
                ],
            ],
        ],
        'negate' => [
