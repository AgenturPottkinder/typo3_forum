...
$TCA['tx_typo3forum_domain_model_forum_forum'] = array(
	'ctrl' => $TCA['tx_typo3forum_domain_model_forum_forum']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l18n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_typo3forum_domain_model_forum_forum.uid=###REC_FIELD_l18n_parent### AND tx_typo3forum_domain_model_forum_forum.sys_language_uid IN (-1,0)',
			)
		),
