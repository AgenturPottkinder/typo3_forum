...
$TCA['tx_typo3forum_domain_model_forum_post'] = array(
	'ctrl' => $TCA['tx_typo3forum_domain_model_forum_post']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l18n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_typo3forum_domain_model_forum_post.uid=###REC_FIELD_l18n_parent### AND tx_typo3forum_domain_model_forum_post.sys_language_uid IN (-1,0)',
			)
		),
