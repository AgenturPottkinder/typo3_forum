...
return [
    ...
    'columns' => [
        ...
        'type' => [
            ...
            'config' => [
                ...
                'items' => [
                    ...
                    ['LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xlf:tx_typo3forum_domain_model_format_textparser.type.quote', 'Mittwald\Typo3Forum\Domain\Model\Format\QuoteBBCode'],
                    ['LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xlf:tx_typo3forum_domain_model_format_textparser.type.list', 'Mittwald\Typo3Forum\Domain\Model\Format\ListBBCode'],
        ...
        'icon_class' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xlf:tx_typo3forum_domain_model_format_textparser.icon_class',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
        ...
        'language' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:typo3_forum/Resources/Private/Language/locallang_db.xlf:tx_typo3forum_domain_model_format_textparser.language',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
