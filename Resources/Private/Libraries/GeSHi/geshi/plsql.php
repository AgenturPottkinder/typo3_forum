...
$language_data = [
    'LANG_NAME' => 'PL/SQL',
    'COMMENT_SINGLE' => [1 =>'--'], //http://download-uk.oracle.com/docs/cd/B10501_01/appdev.920/a96624/02_funds.htm#2930
    'COMMENT_MULTI' => ['/*' => '*/'], //http://download-uk.oracle.com/docs/cd/B10501_01/appdev.920/a96624/02_funds.htm#2950
    'CASE_KEYWORDS' => GESHI_CAPS_UPPER,
    'QUOTEMARKS' => ["'", '"'], //http://download-uk.oracle.com/docs/cd/B10501_01/appdev.920/a96624/02_funds.htm
    'ESCAPE_CHAR' => '\\',
    'KEYWORDS' => [
        //PL/SQL reserved keywords (http://download-uk.oracle.com/docs/cd/B10501_01/appdev.920/a96624/f_words.htm#LNPLS019)
        1 => ['ZONE', 'YEAR', 'WRITE', 'WORK', 'WITH', 'WHILE', 'WHERE',
        ...
        2 => ['XMLTRANSFORM', 'XMLSEQUENCE', 'XMLFOREST', 'XMLELEMENT',
        ...
        3 => ['UTL_URL', 'UTL_TCP', 'UTL_SMTP', 'UTL_REF', 'UTL_RAW',
        ...
        4 => ['ZERO_DIVIDE', 'VALUE_ERROR', 'TOO_MANY_ROWS',
        ...
        5 => ['USER_REPSITES', 'USER_REPSCHEMA',
