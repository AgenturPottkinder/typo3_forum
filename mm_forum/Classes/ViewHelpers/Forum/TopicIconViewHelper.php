 ...
 *
 */
class Tx_MmForum_ViewHelpers_Forum_TopicIconViewHelper
	 ...
	 *
	 */
	public function render(Tx_MmForum_Domain_Model_Forum_Topic $topic=NULL,
			$width=NULL) {
		return parent::render('plugin.tx_mmforum.renderer.icons.topic',
						$this->getDataArray($topic));
	}
