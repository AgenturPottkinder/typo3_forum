...
class NotificationRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	 ...
	 * @param int $limit
	 * @return \Mittwald\MmForum\Domain\Model\User\Notification[]
	 */
	public function findNotificationsForUser(\Mittwald\MmForum\Domain\Model\User\FrontendUser $user, $limit=0) {
